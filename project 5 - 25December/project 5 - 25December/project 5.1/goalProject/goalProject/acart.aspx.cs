    ...
    public partial class cart : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["userID"] != null)
            {
                ...
                // Creating Connection
                con5 = new SqlConnection("data source=DESKTOP-HDRIDJ6\\SQLEXPRESS; database=goalProject; integrated security=SSPI");
                // writing sql query
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con = new SqlConnection("data source =DESKTOP-HDRIDJ6\\SQLEXPRESS; database=goalProject; integrated security=SSPI");
                con2 = new SqlConnection("data source=  DESKTOP-HDRIDJ6\\SQLEXPRESS; database=goalProject; integrated security=SSPI");
                con3 = new SqlConnection("data source=  DESKTOP-HDRIDJ6\\SQLEXPRESS; database=goalProject; integrated security=SSPI");
                con4 = new SqlConnection("data source=  DESKTOP-HDRIDJ6\\SQLEXPRESS; database=goalProject; integrated security=SSPI");
                ...
                while (sdr.Read())
                {
                    SqlCommand cm3 = new SqlCommand($"insert into orders_details(order_datee, product_id) values ('{currentDate}', '{sdr[1]}');", con3);
                    con3.Open();
                    cm3.ExecuteNonQuery();
                    con3.Close();
                }
